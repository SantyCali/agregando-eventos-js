...
/* -------- Agrego el Evento para que ingrese el DNI del usuario ------ */
...
dni.className = "dni-2";
dni.innerHTML = `Ingrese su DNI ${nombre2}`;

    formulario.addEventListener("submit", (e) => {
        e.preventDefault();
        contenedor.innerHTML = "";
        let inputs = e.target.children;
        info.push(inputs[0].value);
...
/* ------------- Agrego el Botón del saludo ----------------- */
const saludar = () => {
  alert(`Hola! ${nombre2}, Mucha suerte en el sorteo!`);
};
